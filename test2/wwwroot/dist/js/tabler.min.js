...
!(function (t) {
  ...
  class qn extends ls {
    ...
    _checkContent(t) {
      for (const [e, s] of Object.entries(t))
        super._typeCheckConfig({ selector: e, entry: s }, Hn);
    }
    _setContent(t, e, s) {
  ...
  class er extends us {
    ...
    _createTipElement(t) {
      ...
      return (
        e.setAttribute("id", s), this._isAnimated() && e.classList.add(Un), e
      );
    }
    setContent(t) {
      (this._newContent = t),
    ...
    _isAnimated() {
      return (
        this._config.animation || (this.tip && this.tip.classList.contains(Un))
      );
    }
    _isShown() {
        ...
        if ("click" === e)
          ...
          is.on(this._element, t, this._config.selector, (t) => {
            ...
            is.on(this._element, s, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              (e._activeTrigger["focusout" === t.type ? Zn : Qn] =
      ...
      getColor: function (t) {
        var e =
          ...
          s = getComputedStyle(document.body)
            .getPropertyValue("--".concat(Jr).concat(t))
            .trim();
        return 1 !== e ? to(s, e) : s;
      },
    });
